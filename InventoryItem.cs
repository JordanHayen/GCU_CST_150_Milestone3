...
namespace Milestone3
{
    ...
    class InventoryItem
    {
        ...
        public int Stock { get; private set; } // Defines an integer property called Stock that can be accessed outside of the class but that can only be directly modified within the class
